...
import { Upload, FileImage, X, Check, Edit3, AlertCircle } from "lucide-react";
          ...
          <div className="bg-card rounded-2xl border border-border p-6">
            ...
            {!results ? (
              <div className="text-center py-16">
                ...
                <p className="text-sm text-muted-foreground">Upload a prescription to see AI-extracted data</p>
              </div>
            ) : (
              <div className="space-y-4">
                ...
                <Button className="w-full gap-2 rounded-xl mt-4" onClick={() => toast.success("Prescription validated!")}>
